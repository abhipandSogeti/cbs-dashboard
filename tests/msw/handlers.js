...
export const handlers = [
    http.get(`${CBS_BASE}/83765NED/TypedDataSet`, () => HttpResponse.json(mockPopulationResponse)),
    http.get(`${CBS_BASE}/85039NED/TypedDataSet`, () => HttpResponse.json(mockLabourResponse)),
    http.get(`${CBS_BASE}/84410NED/TypedDataSet`, () => HttpResponse.json(mockEconomyResponse)),
